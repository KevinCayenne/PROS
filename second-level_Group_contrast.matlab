	...
	for TimeC = 0:timeCourseC
		switch Contrast_Cond 
			...
			case 30 %% Y_Sit - Baseline (Y) 132/11 - 60..70
				for ConCount1 = 1:SitCount
					matlabbatch{1}.spm.stats.con.consess{counter}.tcon.name = ['Y_Situ_Baseline_' int2str(ConCount1)];
					matlabbatch{1}.spm.stats.con.consess{counter}.tcon.weights = [...
																				  zeros(1, AllTC*(ConCount1-1))...
					    														  repmat(-1/timeCourseC,1,TimeC) ones(1,1) repmat(-1/timeCourseC,1,timeCourseC-TimeC)...
					    														 ];
			...
			case 31 %% O_Sit - Baseline (O) 132/11 - 71..81
				...
				for ConCount1 = 1:SitCount
					matlabbatch{1}.spm.stats.con.consess{counter}.tcon.name = ['O_Situ_Baseline_' int2str(ConCount1)];
					matlabbatch{1}.spm.stats.con.consess{counter}.tcon.weights = [...
																				  zeros(1, (AllTC*ConCount1)+(AllTC*(ConCount1-1)))...
					    														  repmat(-1/timeCourseC,1,TimeC) ones(1,1) repmat(-1/timeCourseC,1,timeCourseC-TimeC)...
					    														 ];
					matlabbatch{1}.spm.stats.con.consess{counter}.tcon.sessrep = 'none';
					counter = counter + 1;
			...
			case 32 %% Y_NEU-PROS Sit (Y) 12/1 - 82
					matlabbatch{1}.spm.stats.con.consess{counter}.tcon.name = ['Y_NEU_PROS_Situ'];
					matlabbatch{1}.spm.stats.con.consess{counter}.tcon.weights = [...
					    														  repmat(1/timeCourseC,1,TimeC) repmat(-1,1,1) repmat(1/timeCourseC,1,timeCourseC-TimeC)...
					    														  zeros(1, AllTC)...
					    														  repmat(-1/timeCourseC,1,TimeC) ones(1,1) repmat(-1/timeCourseC,1,timeCourseC-TimeC)...
			...
			case 33 %% Y_NEU-PUR Sit (Y) 12/1 - 83
					matlabbatch{1}.spm.stats.con.consess{counter}.tcon.name = ['Y_NEU_PUR_Situ'];
					matlabbatch{1}.spm.stats.con.consess{counter}.tcon.weights = [...
																				  zeros(1, AllTC)...
					    														  repmat(1/timeCourseC,1,TimeC) repmat(-1,1,1) repmat(1/timeCourseC,1,timeCourseC-TimeC)...
					    														  repmat(-1/timeCourseC,1,TimeC) ones(1,1) repmat(-1/timeCourseC,1,timeCourseC-TimeC)...
			...
			case 34 %% Y_NEU-UNCOM Sit (Y) 12/1 - 84
					matlabbatch{1}.spm.stats.con.consess{counter}.tcon.name = ['Y_NEU_UNCOM_Situ'];
					matlabbatch{1}.spm.stats.con.consess{counter}.tcon.weights = [...
																				  zeros(1, AllTC*2)...
																				  repmat(-1/timeCourseC,1,TimeC) ones(1,1) repmat(-1/timeCourseC,1,timeCourseC-TimeC)...
																				  repmat(1/timeCourseC,1,TimeC) repmat(-1,1,1) repmat(1/timeCourseC,1,timeCourseC-TimeC)...
			...
			case 35 %% O_NEU-PROS Sit (O) 12/1 - 85
					matlabbatch{1}.spm.stats.con.consess{counter}.tcon.name = ['O_NEU_PROS_Situ'];
					matlabbatch{1}.spm.stats.con.consess{counter}.tcon.weights = [...
																				  zeros(1, AllTC*SitCount)...
																				  repmat(1/timeCourseC,1,TimeC) repmat(-1,1,1) repmat(1/timeCourseC,1,timeCourseC-TimeC)...
					    														  zeros(1, AllTC)...
			...
			case 36 %% O_NEU-PUR Sit (O) 12/1 - 86
					matlabbatch{1}.spm.stats.con.consess{counter}.tcon.name = ['O_NEU_PUR_Situ'];
					matlabbatch{1}.spm.stats.con.consess{counter}.tcon.weights = [...
																				  zeros(1, AllTC*SitCount)...
																				  zeros(1, AllTC)...
					    														  repmat(1/timeCourseC,1,TimeC) repmat(-1,1,1) repmat(1/timeCourseC,1,timeCourseC-TimeC)...
			...
			case 37 %% O_NEU-UNCOM Sit (O) 12/1 - 87
					matlabbatch{1}.spm.stats.con.consess{counter}.tcon.name = ['O_NEU_UNCOM_Situ'];
					matlabbatch{1}.spm.stats.con.consess{counter}.tcon.weights = [...
																				  zeros(1, AllTC*SitCount)...
																				  zeros(1, AllTC*2)...
																				  repmat(-1/timeCourseC,1,TimeC) ones(1,1) repmat(-1/timeCourseC,1,timeCourseC-TimeC)...
			...
			case 38 %% PRO(Y) - PUR(Y) - PRO(O) + PUR(O) 12/1 - 88
					matlabbatch{1}.spm.stats.con.consess{counter}.tcon.name = ['PRO(Y)_PUR(Y)__PRO(O)_PUR(O)'];
					matlabbatch{1}.spm.stats.con.consess{counter}.tcon.weights = [...
					    														  repmat(-1/timeCourseC,1,TimeC) ones(1,1) repmat(-1/timeCourseC,1,timeCourseC-TimeC)...
					    														  repmat(1/timeCourseC,1,TimeC) repmat(-1,1,1) repmat(1/timeCourseC,1,timeCourseC-TimeC)...
			...
			case 39 %% PRO(Y) - NEU(Y) - PRO(O) + NEU(O) 12/1 - 89
					matlabbatch{1}.spm.stats.con.consess{counter}.tcon.name = ['PRO(Y)_NEU(Y)__PRO(O)_NEU(O)'];
					matlabbatch{1}.spm.stats.con.consess{counter}.tcon.weights = [...
					    														  repmat(-1/timeCourseC,1,TimeC) ones(1,1) repmat(-1/timeCourseC,1,timeCourseC-TimeC)...
					    														  zeros(1, AllTC)...
					    														  repmat(1/timeCourseC,1,TimeC) repmat(-1,1,1) repmat(1/timeCourseC,1,timeCourseC-TimeC)...
