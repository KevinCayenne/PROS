...
cond.num <- 11
timec <- 12
phase.tag <- c(rep(1, 4*timec*young.num), rep(2, 7*timec*young.num), rep(1, 4*timec*old.num), rep(2, 7*timec*old.num))
...
g1 <- g1 + geom_line(aes(y=old.phase1.tb), colour="red")
g1 <- g1 + geom_line(aes(y=young.phase1.tb), colour="green")
g1

g2 <- ggplot(norm.phase2.df, aes(x=tc))
g2 <- g2 + geom_line(aes(y=old.phase2.tb), colour="red")
g2 <- g2 + geom_line(aes(y=young.phase2.tb), colour="green")
g2
