...
setwd("c:/Users/BMLabGoh-K/Desktop/tempData/")
...
ER.ROI.final <- cbind(ER.ROI, ER.temp.PP$emo.rate, ER.temp.PP$dist)
colnames(ER.ROI.final) <- c("sub.tag", "sit.tag", "reg.tag", "age.tag", "signal_value", "emo.rate", "dist")

ggscatter(ER.ROI.final, x = "emo.rate", y = "signal_value",
          color = "age.tag", 
          cor.coef = TRUE,
...
ggscatter(ER.ROI.final, x = "dist", y = "signal_value",
          color = "age.tag", 
          cor.coef = TRUE,
          conf.int = TRUE, cor.method = "spearman",
          xlab = "values", ylab = "Parameter Estimate",
...
ggscatter(ER.ROI.final, x = "reg.tag", y = "signal_value",
          color = "age.tag", 
          cor.coef = TRUE,
          conf.int = TRUE, cor.method = "spearman",
          xlab = "values", ylab = "Parameter Estimate",
...
ggline(ER.ROI.final, x = "sit.tag", y = "signal_value", add = "mean_se",
       color = "age.tag",
       add.params = list(group = "age.tag"),
       fill = "age.tag",
       xlab = "Group", ylab = "Parameter Estimate",
